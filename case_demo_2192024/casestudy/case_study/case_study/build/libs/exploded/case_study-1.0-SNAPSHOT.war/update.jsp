...
<div class="container mt-5">
    ...
    <form action="?action=edit" method="post">
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="id" name="id" readonly value="${st.id}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="point" name="point" value="${st.point}">
        </div>
        <div class="form-group">
            <label for="classId">Lớp học:</label>
            <select class="form-control" id="classId" name="classId" required>
                <option value="" disabled>Chọn lớp học</option>
                <option value="1" ${st.clazz.classId == 1 ? "selected" : ""}>Backend-01</option>
                <option value="2" ${st.clazz.classId == 2 ? "selected" : ""}>Backend-02</option>
                <option value="3" ${st.clazz.classId == 3 ? "selected" : ""}>Frontend-01</option>
                <option value="4" ${st.clazz.classId == 4 ? "selected" : ""}>Fullstack</option>
            </select>
        </div>

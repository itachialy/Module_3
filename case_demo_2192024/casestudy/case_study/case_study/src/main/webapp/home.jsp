...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/home.css"> <!-- Liên kết đến file CSS -->

</head>
<body>
<div class="container">
    <h1 class="text-center" style="font-family: 'Comic Sans MS'">Welcome to CODEGYMER UNIVERSITY</h1>
    ...
    <div class="centers">
        <a href="student-servlet" class="button">Danh sách học viên</a>
    </div>

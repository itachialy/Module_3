    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col">
            <form action="?action=filter" method="get" class="form-inline d-flex">
                ...
                <input type="text" name="name" class="form-control flex-grow-1" placeholder="Nhập tên học viên cần tìm..." >
                <input type="text" name="email" class="form-control flex-grow-1 ml-2" placeholder="Nhập email học viên cần tìm..." >
                <label>
                    <select name="className" class="form-control ml-2">
                        <option value="all">Tất cả lớp</option> <!-- Tùy chọn mặc định -->

...
public class StudentServlet extends HttpServlet {
    ...
    public void filterStudents(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //set className = null để không filter theo class
        if(className.equals("all")){
            className = null;
        }
        // Sử dụng cả tên và lớp để tìm kiếm sinh viên
        List<Student> students = iStudentService.filterStudents(name,email,className );
    ...
    private void addNewStudent(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        if (iStudentService.existEmail(email)) {
